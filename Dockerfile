...
# How to build:
#
# docker build -t 345280441424.dkr.ecr.ap-south-1.amazonaws.com/ark_alfresco_ce_content:7.3.1 .
# docker push 345280441424.dkr.ecr.ap-south-1.amazonaws.com/ark_alfresco_ce_content:7.3.1
#
# How to run: (Docker)
